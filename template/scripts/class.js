function ClassAdmin(id, teacher, name, subject){
    ...
    this.getHTML = function(){
        ...
        html += "           <button class='pure-button pure-button-primary' style='display: inline-block; padding: .5em .9em' onclick='viewMembers(\""+this.id+"\", 1)'>Students</button>";
        html += "           <button class='pure-button pure-button-primary' style='display: inline-block; padding: .5em .9em' onclick='viewMembers(\""+this.id+"\", 2)'>Edit</button>";
        html += "       </div>";
        html += "   </div>";
        html += "</div>";
        return html;
